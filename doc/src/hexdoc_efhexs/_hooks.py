...
import hexdoc_efhexs

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class EfhexsPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return EfhexsModPlugin(branch=branch)


class EfhexsModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "efhexs"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_efhexs, "_templates"
